...
def send_email(email_address, facebook_video_link):
    ...
    'Video of your talk', """Good news! We’ve edited down a video of your talk, which some might say is now perfect for sharing. Want to share your talk with your network? You can find your edited video here {}.""" .format(email_address, facebook_video_link))
