...
class avenger_requests():
    ...
    def get_talks(self):
        ...
        """
        out = requests.get('https://api.cilabs.com/conferences/{}/timeslots/'.format(self.slug))
        return out
    ...
    def get_talks_particular(self, id):
        ...
        """
        out = requests.get('https://api.cilabs.com/conferences/{}/timeslots/'.format(self.slug) + str(id))
        return out
    ...
    def get_locations(self):
        ...
        """
        out = requests.get('https://api.cilabs.com/conferences/{}/timeslot_locations'.format(self.slug))
        return out
    ...
    def get_locations_particular(self, timeslot_location_id):
        ...
        """
        out = requests.get('https://api.cilabs.com/conferences/{}/timeslot_locations/'.format(self.slug) + str(timeslot_location_id))
        return out
    ...
    def get_attendee_data(self):
        ...
        out = requests.get('https://api.cilabs.com/conferences/{}/attendances?per_page=200'.format(self.slug),headers = headers)
        return out
    ...
    def get_attendee_data_particular(self, attendance_id):
        ...
        """
        headers = {'Authorization': 'Bearer {}'.format(os.environ['avenger_token'])}
        out = requests.get('https://api.cilabs.com/conferences/{}/attendances/{}'.format(self.slug,attendance_id),headers = headers)
        return out
...
if __name__ == '__main__':
    ...
    #https://api.cilabs.com/conferences/ws18/timeslots/
