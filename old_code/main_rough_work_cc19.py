...
######THIS IS JUST COMMENTED OUT ; DON'T KNOW WHAT IT WAS NEEDED FOR
            ...
            try:
                youtube_post = youtube_video_upload(file= file_location + 'edited_videos/' + message,title= title_for_youtube, 
                description=description,keywords='Web Summit, web summit lisbon, web summit conference lisbon, web summit paddy,' 
                'web summit portugal, web summit portugal 2018, web summit video, web summit youtube, Web summit lisboa, {}'.format(speakers_for_youtube_tag),
